...
namespace AsImpL
{
    ...
    public abstract class Loader : MonoBehaviour
    {
        ...
        public IEnumerator Load(string objName, string absolutePath, Transform parentObj)
        {
            ...
            if(GameObject.Find("MyObject/shadow_G_")){
                Texture shadow;
                shadow = GameObject.Find("MyObject/shadow_G_").GetComponent<MeshRenderer>().material.mainTexture;
                Material newMaterial = new Material(Shader.Find("Mobile/Particles/Alpha Blended"));
                newMaterial.mainTexture = shadow;
                GameObject.Find("MyObject/shadow_G_").GetComponent<MeshRenderer>().material = newMaterial;
            }
